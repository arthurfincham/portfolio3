...
export const fontApp = {
  ...
  description: [
    'Font preview app.',
    'Anti-decision-paralysis.',
    'Toggles for weight, size and italic.',
    'Custom themes.',
...
export const newsforce = {
  ...
  description: [
    'API based news aggregation project.',
    'React.JS front-end.',
    'RoR API based backend.',
...
export const classNotes = {
  ...
  description: [
    'RoR backend.',
    'PostgreSQL database.',
    'Personal project built before bootcamp.',
    'Filtering by tags.',
...
export const chitter = {
  ...
  description: [
    'Twitter clone.',
    'Boostrap only for front-end (no custom CSS).',
    'Hashtags are extracted from the text in each Peep.',
    'Ability to click on tags and filter Peeps.',
